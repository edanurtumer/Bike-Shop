<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zam.aspx.cs" Inherits="_161213027_Edanur_Tümer.Zam" %>
		...
		<div class="feature-main container-fluid">
			<div class="row">
				<div class="col-lg-4 feature text-left" data-aos="fade-right">
					<h3>ZAM</h3>
					<p>&nbsp;<asp:TextBox ID="TextBox1" runat="server" value="Ne kadar zam yapılsın?" onfocus="this.value='';" onblur="if(this.value==''){this.value='Ne kadar zam yapılsın?'}"></asp:TextBox>
                    </p>
                    <p>&nbsp;</p>
					<div class="read inner mt-4">
						
                               <asp:Button ID="Button1" runat="server" Text="ZAM YAP" OnClick="Button1_Click" />
					</div>
				</div>
